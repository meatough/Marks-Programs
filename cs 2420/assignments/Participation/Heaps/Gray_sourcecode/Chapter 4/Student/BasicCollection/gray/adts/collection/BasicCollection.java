 ...
 private static final int DEFAULT_SIZE = 100;
  ...
  public boolean remove( Object element ) {
    ...
    for ( int i = p; i < size - 1; i++ ) {
      collection[i] = collection[i + 1];		//lines 121-123 move elements up in list
    }
  ...
  private class BasicIterator implements Iterator<E> {	//this class is inside basic collection class
    /**
