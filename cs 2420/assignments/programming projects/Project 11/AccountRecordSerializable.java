...
public class AccountRecordSerializable implements Comparable<AccountRecordSerializable>, Serializable
{
   private int account;
   ...
   { 
	...
	public int compareTo(AccountRecordSerializable other)
	{
		if(other == null)
		{
