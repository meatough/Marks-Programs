...
public class SinglyLinkedList<E> 
{
   ...
   */
	...
	//generic display list method added to singly linked list
	...
	//generic method to 
	public void recursiveMethod(int j)
	{
		/*********************************************************
		In a recursive method, there are subalogrithms within 
		a larger algorithm that has the same organization as
		the algorithm as a whole. 
		
		In this method we have a recursive case and a base case.
		The base case executecution is generally the simplest 
		part of the method, in this case the base case executes 
		only if there is only one element left to be printed.  
		So if there was only one element in our list than the 
		base case would execute and the recursive case would not. 
		
		In this method the recursive case executes so long as there 
		is more than one element in the list that has not been 
		printed.  Because we are using a sequential data structure 
		as the backing store for our lists, we must iterate to the 
		end of the list and print that element, and then start at 
		the beginnning of the list and iterate to one position less
		than the end of the list and then print that element and so
		on.  So when we are at the first element in the list, or 
		there is only one element in the list the base case executes
		and the recursive case does not. 
		**********************************************************/
