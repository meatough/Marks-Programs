...
/**
 *  A linked-list implementation of the <code>Entry</code>
 *  class used to create a chained hash table.
 */
public class LinkEntry<K, V> extends Entry<K,
   ...
   *     for this entry
   * @param n the link to the successor entry in this chain
   ...
   * @param newSuccessor the new link to the successor entry
   *  in this chain
   */
