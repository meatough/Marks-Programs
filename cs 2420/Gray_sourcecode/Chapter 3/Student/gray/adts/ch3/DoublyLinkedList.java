...
/**
 * Description:  A simple singly-linked list introduced in the chapter
...
public class DoublyLinkedList<E> {
   ...
   * singly linked list
   * @param e the element to add
   * @param p position to insert <code>e</code>; must be in the
   * range 0 to <code>this.size()</code>.
   ...
   * @return the element from position <code>p</code> of this
   *        linked list
   * @throws  IndexOutOfBoundsException  if the index p is outside
   * the range 0 to <code>length - 1</code>.
   */
  ...
  /* find - find the first node containing target, return null
   ...
   * throw an exception if the index p is outside the
   * range 0 to this.length - 1
   */
