...
public class TestGraph extends TestCase {
  ...
  public void testRemoveVertex2() {
    ...
    assertEquals( 1, graph2.getNumberOfEdges() );
    ArrayList<Vertex<String>> neighbors =
        ( ArrayList<Vertex<String>> ) graph2.getNeighbors( v2 );
    assertEquals( 1, neighbors.size() );
    assertTrue( neighbors.contains( v3 ) );
    neighbors = ( ArrayList<Vertex<String>> ) graph2.getNeighbors( v3 );
    assertEquals( 1, neighbors.size() );
  ...
  /**
   * Adding duplicate edges should not change the edge count.
   * Since this graph is undirected, this test tries two forms of a
   * duplicate edge (v1 to v2 and v2 to v1).
   */
  ...
  public void testbfsSearch() {
    BFSSearcher<String> bfsSearcher = new BFSSearcher<String> ( bfsGraph );
    ArrayList<Vertex<String>> list = ( ArrayList<Vertex<String>> )
        bfsSearcher.bfs( v1 );
  ...
  public void testbfsSearchGetPathExists() {
    BFSSearcher<String> bfsSearcher = new BFSSearcher<String> ( bfsGraph );
    ArrayList<Vertex<String>> thePath = ( ArrayList<Vertex<String>> )
        bfsSearcher.getPath( v1, v6 );
