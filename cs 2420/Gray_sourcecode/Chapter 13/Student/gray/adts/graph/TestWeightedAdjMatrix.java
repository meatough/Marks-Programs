...
public class TestWeightedAdjMatrix extends TestCase {
  private WeightedAdjMatrixGraph<String> graph1 = null, graph2 = null;
  ...
  public void testPath() {
    ...
    DFSSearcher<String> dfs = new DFSSearcher<String> ( graph2 );
  ...
  public void testPathLength() {
    ...
    graph1.addVertex( v2 );
    DFSSearcher<String> dfs = new DFSSearcher<String> ( graph1 );
    assertTrue( dfs.containsPath( v1, v3 ) );
  ...
  public void testGetPath() {
    ...
    graph1.addVertex( v5 );
    graph1.addEdge( v3, v5 ); // v3 <-> v5
    Vertex<String> disconnected = new Vertex<String> ( "Disconnected" );
    ...
    ArrayList<Vertex<String>> thepath =
        ( ArrayList<Vertex<String>> ) dfs.getPath( v1, v5 );
  ...
  public void testAddVertexNotInGraph() {
    ...
    try {
      graph2.addEdge( v1, v4 );
      this.fail( "Not good - found a non-existent edge" );
    }
    catch ( IllegalArgumentException e ) {}
    try {
      graph2.addEdge( v4, v1 );
      this.fail( "ot good - found a non-existent edge" );
    }
    catch ( IllegalArgumentException e ) {}
  }
  ...
  public void testMinimalPathAlgorithm() {
    ...
    double path = graph1.minimalPath( a, e );
